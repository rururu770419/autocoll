...
def api_get_customer_fields(store):
    ...
    try:
        ...
        # カテゴリ一覧を取得
        categories = get_all_categories(store_code)
        
        # 各カテゴリの選択肢を取得
        options = {}
        for category in categories:
            field_key = category['field_key']
            options[field_key] = get_field_options(store_code, field_key)
...
def api_get_customer_field_options_for_edit(store):
    ...
    try:
        ...
        # すべての選択肢を取得
        all_options = get_all_field_options(store_code)
...
def api_update_category_label(store):
    ...
    try:
        ...
        success = update_category_label(store_code, field_key, field_label)
...
def api_add_field_option(store):
    ...
    try:
        ...
        option_id = add_field_option(store_code, field_key, option_value, display_color)
...
def api_update_field_option(store, option_id):
    ...
    try:
        ...
        success = update_field_option(option_id, option_value, display_color)
...
def api_toggle_field_option_visibility(store, option_id):
    ...
    try:
        ...
        success = toggle_field_option_visibility(option_id, is_hidden)
...
def api_delete_field_option(store, option_id):
    ...
    try:
        store_code = session['store']
        result = delete_field_option(store_code, option_id)
...
def api_move_field_option(store, option_id):
    ...
    try:
        ...
        result = move_field_option(store_code, option_id, direction)
